...
export default class MemberDietDetails extends React.Component {
    _isMounted = false
    state = {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#eeeeee', transform: transform() }}>
                ...
                <View style={{ width: w / 1.1, marginLeft: 'auto', marginRight: 'auto', justifyContent: 'flex-end', flexDirection: 'row', marginTop: width / 30 }} >
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('UpdateMemberDiet', { memberId: this.props.navigation.getParam('memberId'), date: this.props.navigation.getParam('date'), session: this.state.dietPlanSession._id })}>
                    ...
                    <View style={{ width: w / 1.05, flexDirection: 'row', justifyContent: 'space-between', marginLeft: 'auto', marginRight: 'auto', flexWrap: 'wrap', marginTop: width / 20 }}>
                        {this.state.dietPlan.map((data, i) => {
                            return (
                                ...
                                <View style={{ width: w / 2.2, backgroundColor: '#e0f7fa', borderWidth: 1, paddingBottom: width / 30, borderRadius: 5, borderColor: '#80deea', marginTop: width / 50 }}>
