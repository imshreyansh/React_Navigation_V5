...
class UpdateMemberDiet extends Component {
    _isMounted = false
            ...
            <View style={{ transform: transform(), flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={{ width: w, height: width / 6.5, backgroundColor: 'white', flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#ddd' }}>
                    <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                        ...
                        <Text style={{ marginLeft: width / 7, bottom: width / 30, fontSize: width / 18, color: '#333', transform: transform(), textAlign: textAlign(), fontWeight: 'bold', }}>{i18n.t('updateDiet')}</Text>
                    </TouchableOpacity>
                </View>
                        ...
                        return (
                            <View key={i} style={{ marginTop: width / 20, width: w / 1.1, borderWidth: 1, marginLeft: 'auto', marginRight: 'auto', paddingBottom: width / 20, backgroundColor: '#f5f5f5', borderColor: '#ddd' }}>
                                <View style={{ width: w / 1.1, flexDirection: 'row', justifyContent: 'space-between', marginLeft: 'auto', marginRight: 'auto' }}>
                                    ...
                                    <Text style={{ transform: transform(), marginTop: width / 30, marginLeft: width / 30, fontSize: width / 28, color: '#e53935', width: w / 3, textAlign: 'center' }}>{Math.round((data.foodItem.calories / data.foodItem.measurementValue) * data.measureValue)} {i18n.t('calories')}</Text>
...
export default UpdateMemberDiet