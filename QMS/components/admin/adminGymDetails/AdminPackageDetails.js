...
export default class AdminPackageDetails extends React.Component {
    _isMounted = false
            ...
            <View style={{ transform: transform(), backgroundColor: 'white', flex: 1 }}>
                ...
                <View elevation={3} style={{ width: w, height: width / 7, backgroundColor: 'white', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={{ marginLeft: width / 20, top: width / 30, fontSize: width / 18, color: '#333', fontWeight: 'bold', transform: transform(), textAlign: textAlign(), }}>Package Details</Text>
                    </View>
                </View>
