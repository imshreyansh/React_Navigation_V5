...
class TrainerQuestionTwo extends Component {
    ...
    onSubmit = () => {
        ...
        if (id.questionTwo !== '') {
            this.props.navigation.navigate('TrainerQuestionThree', { id, oldPackageId: this.props.navigation.getParam('oldPackageId') })
        } else {
...
export default TrainerQuestionTwo