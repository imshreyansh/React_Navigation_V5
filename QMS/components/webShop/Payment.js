                    ...
                    <View elevation={3} style={{ width: w, height: width / 6.5, backgroundColor: 'white', flexDirection: 'row', justifyContent: 'space-between' }}>
                        <View style={{ flexDirection: 'row' }}>
                            <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                                ...
                                <Text style={{ marginLeft: width / 7, bottom: width / 30, fontSize: width / 18, color: '#333', transform: transform(), textAlign: textAlign(), fontWeight: 'bold', }}>Payments</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    <TouchableOpacity>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: w / 1.1, backgroundColor: 'white', marginLeft: 'auto', marginRight: 'auto', marginTop: width / 20, paddingBottom: width / 30, borderRadius: 3 }}>
                            <View style={{ flexDirection: 'row' }}>
                                <Icon name="add-mobile" size={width / 15} style={{ marginTop: 'auto', marginBottom: 'auto', marginLeft: width / 30, top: width / 80, }} color="grey" />

                                <View style={{ flexDirection: 'column', marginTop: width / 30, marginLeft: width / 30 }}>
                                    <Text style={{ fontSize: width / 28, color: '#333', transform: transform(), textAlign: textAlign(), }}>{i18n.t('payWithCreditCard')}</Text>
                                    <Text style={{ fontSize: width / 35, color: 'grey', transform: transform(), textAlign: textAlign(), }}>Visa or Mastercard</Text>
                                </View>
                            </View>
                    ...
                    <TouchableOpacity>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: w / 1.1, backgroundColor: 'white', marginLeft: 'auto', marginRight: 'auto', marginTop: width / 20, paddingBottom: width / 30, borderRadius: 3 }}>
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ flexDirection: 'column', marginTop: width / 30, marginLeft: width / 30 }}>
                                    <Text style={{ fontSize: width / 28, color: '#333', transform: transform(), textAlign: textAlign(), }}>{i18n.t('payAtGym')}</Text>
