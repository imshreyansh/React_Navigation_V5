...
import AddedDietByTrainer from './AddedDietByTrainer'


class AssignDietNavigator extends Component {
    ...
    render() {
        ...
        const Tabs = createMaterialTopTabNavigator({
            AssignDiet: {
                screen: AssignDiet,
                navigationOptions: {
                    tabBarLabel: i18n.t('addDiet'),
                }
            },
            AddedDietByTrainer: {
                screen: AddedDietByTrainer,
                navigationOptions: {
                    tabBarLabel: i18n.t('updateDiet'),
                }
            },
            ...
            <View style={{ transform: transform(), flex: 1, backgroundColor: 'white' }}>
                ...
                <View elevation={3} style={{ width: w, height: width / 7, backgroundColor: 'white', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={{ marginLeft: width / 30, top: width / 30, fontSize: width / 18, color: '#333', fontWeight: 'bold', transform: transform(), textAlign: textAlign(), }}>{i18n.t('dietPlans')}</Text>
                    </View>
                </View>
...
export default AssignDietNavigator